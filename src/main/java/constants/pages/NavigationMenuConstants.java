...
public class NavigationMenuConstants {
    ...
    public static final String HAMBURGERITEM_LOCATOR ="#guide-button > paper-ripple";
    public static final String LOGO_LOCATOR ="#logo-icon-container";
    public static final String SEARCHFIELD_LOCATOR ="#search";
    public static final String SEARCH_LOCATOR ="#search-icon-legacy";
    public static final String VIDEOBUTTON_LOCATOR=".style-scope ytd-topbar-menu-button-renderer style-default";
    public static final String APPS_BUTTON_LOCATOR ="#button > yt-icon";
    public static final String SETTINGS_BUTTON_LOCATOR ="#button > yt-icon";
    public static final String SIGNIN_LOCATOR="[aria-label=Sign in]";
    public static final String HOME_BUTTON_LOCATOR ="ytd-guide-entry-renderer a[title='Home']";
    public static final String TRENDING_BUTTON_LOCATOR ="ytd-guide-entry-renderer a[title='Trending']";
    public static final String SUBSCRIPTIONS_BUTTON_LOCATOR = "ytd-guide-entry-renderer a[title='Subscriptions']";
    public static final String LIBRARY_BUTTON_LOCATOR = "ytd-guide-entry-renderer a[title='Library']";
    public static final String HISTORY_BUTTON_LOCATOR = "ytd-guide-entry-renderer a[title='History']";
    public static final String SIGNIN_LIKE_VIDEOS_TEXT_LOCATOR = "";
    public static final String SIGNIN_BUTTON_LOCATOR = "#sign-in-button";
    public static final String GAMING_BUTTON_LOCATOR = "ytd-guide-entry-renderer a[title='Gaming']";
    public static final String MUSIC_BUTTON_LOCATOR ="ytd-guide-entry-renderer a[title='Music']";
    public static final String SPORTS_BUTTON_LOCATOR ="ytd-guide-entry-renderer a[title='Sports']";
    public static final String NEWS_BUTTON_LOCATOR = "ytd-guide-entry-renderer a[title='News']";
    public static final String BEST_OF_YOUTUBE_LOCATOR ="";
    public static final String LIVE_BLACK_BUTTON_LOCATOR ="ytd-guide-entry-renderer a[title='Live']";
    public static final String FASHION_BUTTON_LOCATOR ="ytd-guide-entry-renderer a[title='Fashion']";
    public static final String VIDEO360_BUTTON_LOCATOR ="ytd-guide-entry-renderer a[title='360° Video']";
    public static final String BROWS_CHANNELS_LOCATOR ="ytd-guide-entry-renderer a[title='Browse channels']";
    public static final String MORE_FROM_YOUTUBE_LOCATOR ="yt-formatted-string:contains('More from TouTube')";
    public static final String LIVE_RED_BUTTON_LOCATOR ="ytd-guide-entry-renderer a[title='Live']";
    public static final String SETTINGS_LEFT_BUTTON_LOCATOR="ytd-guide-entry-renderer  a[title='Settings']";
    public static final String REPORT_HISTORY_BUTTON_LOCATOR="ytd-guide-entry-renderer  a[title='Report history']";
    public static final String HELP_BUTTON_LOCATOR="ytd-guide-entry-renderer a[title='Help']";
    public static final String SEND_FEEDBACK_BUTTON_LOCATOR ="ytd-guide-entry-renderer a[title='Send feedback']";
    public static final String ABOUT_LOCATOR="ytd-guide-entry-renderer #guide-links-primary > a:nth-child(1)";
    ...
    public static final String VIDEO_BUTTON_EXPECTED_URL ="#sections > yt-multi-page-menu-section-renderer";
    public static final String SETTINGS_BUTTON_EXPECTED_MENU = "";
    public static final String APPS_BUTTON_EXPECTED_MENU ="";
    ...
    public static final String HAMBURGERITEM_EXPECTED ="#guide-icon";
    ...
    public static final String SEND_FEEDBACK_BUTTON_EXPECTED_URL ="body > div:nth-child(3) > div > div";
